...
export function Footer() {
  return (
    <footer style={{ backgroundColor: "#000000" }} className="py-16 text-center">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex justify-center gap-6 mt-4 mb-6">
          <a href="https://www.mikehyzy.com" target="_blank" rel="noopener noreferrer" style={{ color: "#A8F5C8", fontSize: 14, fontFamily: "Inter, sans-serif" }} className="hover:underline">Website</a>
          <a href="#" style={{ color: "#A8F5C8", fontSize: 14, fontFamily: "Inter, sans-serif" }} className="hover:underline">LinkedIn</a>
          <a href="#" style={{ color: "#A8F5C8", fontSize: 14, fontFamily: "Inter, sans-serif" }} className="hover:underline">Forbes Column</a>
        </div>
