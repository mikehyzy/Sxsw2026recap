...
const sessions = [
  ...
  {
    id: 27,
    title: "Social Health Trends & Predictions: Connection is the New Frontier",
    speaker: "Kasley Killam, Author of The Art and Science of Connection",
    date: "Thursday, March 12",
    day: "Day 1",
    track: "Wellness",
    format: "Keynote",
    overview: "Kasley Killam marked a pivotal moment in public health discourse: the recognition of social health as equal in importance to physical and mental health. Loneliness and lack of regular social interaction account for approximately 871,000 deaths annually.",
    ...
    quoteAttribution: "Kasley Killam",
