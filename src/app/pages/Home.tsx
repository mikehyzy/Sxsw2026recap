...
export function Home() {
  ...
  return (
    <div>
          ...
          <div className="relative flex flex-col md:flex-row items-start justify-between gap-8">
            ...
            {timeline.map((t, i) => (
              <div key={i} className="flex-1 relative z-10 cursor-pointer group">
                <div className="w-12 h-12 rounded-full flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform" style={{ backgroundColor: "#12674A", fontSize: 16, fontWeight: 700 }}>
                  {i + 1}
                </div>
                <p style={{ fontSize: 16, fontWeight: 700, color: "#1A1A1A" }}>{t.title}</p>
                <p style={{ fontSize: 14, color: "#6B6B6B" }} className="mb-2">{t.subtitle}</p>
                <p style={{ fontSize: 14, color: "#1A1A1A", lineHeight: 1.6 }}>{t.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ───────── Theme Navigation ───────── */}
      <div className="sticky top-14 z-40 border-b" style={{ borderColor: "#E0E0E0", backgroundColor: "#F7F5F0" }}>
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <ExpandableSection id="critical-consensus" title="What Worked, What Didn't, and Critical Consensus">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white rounded-lg p-6 shadow-sm" style={{ borderLeft: "4px solid #12674A" }}>
                ...
                <ul style={{ fontSize: 14, lineHeight: 1.8, color: "#1A1A1A" }} className="space-y-2 list-disc pl-4">
