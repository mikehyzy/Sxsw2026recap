...
export function Layout() {
  ...
  return (
    <div style={{ fontFamily: "Inter, sans-serif", backgroundColor: "#F7F5F0" }} className="min-h-screen">
      <nav style={{ backgroundColor: "#0A0A0A" }} className="sticky top-0 z-50 border-b border-white/10">
            ...
            {NAV_ITEMS.map((item) => (
              <Link
                ...
                style={{
                  ...
                  backgroundColor: location.pathname === item.path ? "#12674A" : "transparent",
                }}
              >
                {item.label}
              </Link>
